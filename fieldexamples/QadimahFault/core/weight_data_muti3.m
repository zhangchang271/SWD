function [seismo_v_d1,deta_c]=weight_data_muti3(seismo_v_d,seismo_v,is,dt,df,offset,dg,F1,w,M,m,ns,refsx,win,np,vmin,vmax,fmin,fmax,cr_0,cr_0l,cr_pre_r,cr_pre_l,FK,ind)
